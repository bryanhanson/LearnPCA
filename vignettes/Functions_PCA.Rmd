...
```{r overlayScores, fig.width = 5, fig.height = 5, fig.cap = "Comparison of scores computed by `prcomp` (black points) and `princomp` (red points). Note that they are related by a 180 degreee rotation about an axis out of paper at the origin.", echo = FALSE}
plot(pca$x[,1], pca$x[,2], type = "p", pch = 20, col = "gray50",
  xlim = c(-3, 3), ylim = c(-3, 3),
  xlab = "PC1", ylab = "PC2")
points(prin$scores[,1], prin$scores[,2], pch = 20, col = "red")
...
The key takeaway here is that regardless of the signs of the scores and the loadings, they work together.
