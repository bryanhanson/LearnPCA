...
To help us visualize where the first principal component axis lies, Figure 2 shows the same cloud of data (in blue) in three dimensions, and projections of the data (in red) onto the two-dimensional x,y-plane, the y,z-plane, and the x,z-plane. 
...
Here we see that the primary axis runs diagonally from the lower-left to the upper-right, from values of x, y, and z that are negative to values of x, y, and z that are positive. Figure 3 shows the first principal component axis relative to the three-dimensional cloud of data seen in Figure 1 and Figure 2..
...
The cloud of data in the two-dimensional runs diagonally from the lower left of the plane to the upper right of the plane, as we see in Figure 5, where the dashed red line is the second principal component axis.
