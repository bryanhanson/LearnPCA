...
kable(DF, format = "latex", row.names = FALSE, caption = "The \textt{tiny\\_glass} glass data set. Values are percentages.\\label{tab:tinyGlass}") %>% kable_styling(c("striped", "bordered"))
```
