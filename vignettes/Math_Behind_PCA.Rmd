...
Either of these "values" can be used to compute the amount of variance explained by each principal component.  Details are in the "**TODO: TITLE**" vignette.
