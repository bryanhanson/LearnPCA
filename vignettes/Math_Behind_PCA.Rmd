...
So what are eigenvectors and eigenvalues?  If you square the eigenvalues, you have the singular values from SVD. Here "diag" means take the diagonal elements of the matrix (which would a vector of values):[^10]

\begin{equation}
(\#eq:ed3)
\diag{\mathbf{D}} = (\diag{\mathbf{\Lambda}})^2
\end{equation}
