...
**TODO clearly state the audience**
...
```{r}
PCA <- prcomp(X)
mean(U - PCA$x[,1]) # compare the scores
mean(V- PCA$rotation[,1]) # compare the loadings
```
