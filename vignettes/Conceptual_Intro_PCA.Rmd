...
kable(DF, format = "html", digits = 2, caption = "Correlations among selected element concentrations in `glass` data set.") %>% kable_styling(c("striped", "bordered"), full_width = FALSE)
```
## Refinements 1
