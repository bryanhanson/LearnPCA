...
```{r stateScores, fig.cap = "Score plot from PCA on the `states.x77` data set, colored by political leanings (blue = democrat, red = republican, purple = mixed).", fig.asp = 1}
