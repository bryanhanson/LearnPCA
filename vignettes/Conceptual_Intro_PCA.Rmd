...
kable(DF, format = "latex", caption = "A portion of the archaeological glass data set. Values are percentages.\\label{tab:dataTaste}") %>% kable_styling(c("striped", "bordered")) # Tufte ignores this styling!
```
...
```{r glassLoadings, fig.cap = "Loadings plot for PC 1 from PCA on the glass data set.\\label{fig:glassLoadings}"}
...
```{r IRSpectrum, fig.cap = "Spectrum 1 from the IR data set.\\label{fig:IRSpectrum}"}
...
```{r IRLoadings, fig.cap = "Loadings plot for PC 1 from PCA on the IR data set.\\label{fig:IRLoadings}"}
...
```{r IRLoadings2, fig.cap = "Loadings plot for PC 1 from PCA on the IR data set, carbonyl region. Reference spectrum shown in red.\\label{fig:IRLoadings2}"}
...
```{r IRLoadings3, fig.cap = "Loadings plot for PC 1 from PCA on the IR data set, carbonyl region, shown as a bar plot.\\label{fig:IRLoadings3}"}
