...
Let's conduct PCA on this data set (with scaling, because the ranges of the variables differ quite a bit; don't sweat it right now but see [Step By Step PCA](#top-matter) for more details). Figure \@ref(fig:stateScreePlot) shows the scree plot.  Clearly one PC is really important, but perhaps four PCs should be kept.  If we look at the actual numbers suggest five or six PCs would be better, using the 95% rule (Table \@ref(tab:stateScreeTable)).
...
The score plot for this data set is shown in Figure \@ref(fig:stateScores).

```{r stateScores, fig.cap = "Score plot from PCA on the `states.x77` data set.", fig.width = 5, fig.height = 5}
state.col <- c("red", "red", "red", "red", "blue", "blue", "blue", "blue",
"purple", "red", "blue", "red", "blue", "red", "purple", "red",
"red", "red", "blue", "blue", "blue", "blue", "blue", "red",
"red", "red", "red", "blue", "blue", "blue", "blue", "blue",
"red", "red", "purple", "red", "blue", "blue", "blue", "red",
"red", "red", "red", "red", "blue", "blue", "blue", "red", "blue",
"red")
plot(x77$x[,1], x77$x[,2], type = "p", pch = 20,
  xlab = "Principal Component 1", ylab = "Principal Component 2", col = state.col)
```

Finally, the first loadings are shown in Figure \@ref(fig:stateLoadings).

```{r stateLoadings, fig.cap = "Loadings plot for PC 1 from PCA on the state data set."}
