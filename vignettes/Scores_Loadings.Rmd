...
```{r rotate20, fig.align="center", fig.cap="Rotating the original axes by 20° gives the axes shown as solid lines. The small points in pink and in blue are the projections of the original data onto the rotated axes. The gray lines serve as a guide to illustrate the projections for one data point."}
